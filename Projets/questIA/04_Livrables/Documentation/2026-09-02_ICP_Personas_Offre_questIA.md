# questIA — ICP, Personas d'Élite & Copywriting de l'Offre Prestige

## 📌 Document de Référence Commerciale & Stratégie Go-To-Market

---

# ✍️ PARTIE 1 : RÉÉCRITURE PERCUTANTE DE L'OFFRE COMMERCIAL (COPYWRITING HIGH-TICKET)

### 💥 Version 1 : L'Accroche "Combien de Chiffre d'Affaires Perdez-vous ?" (Direct & Provocateur)

> **« Combien de millions d'euros de chiffre d'affaires avez-vous DÉJÀ perdus à cause d'une mauvaise lecture psychologique, d'un biais culturel ou d'un quiproquo en négociation ? »**
>
> Dans les ventes à haut niveau et le business international, ce n'est jamais votre produit qui fait échouer un deal. **C'est votre incapacité à décoder instantanément la psychologie et les codes culturels de votre interlocuteur.**
...
# 👤 PARTIE 3 : CARTE DES 4 PERSONAS CLIENTS POUR questIA

---

## 1. Persona 1 : Thomas, "Le VP Sales International"
* **Âge / Posture** : 42 ans, VP Sales dans une Scale-up Software / SaaS B2B (10M€ à 50M€ de ARR).
* **Contexte & Enjeux** : Pilote des équipes commerciales en Europe et aux US. Gère des cycles de vente de 6 à 18 mois avec des contrats à 250 k€/an.
* **Problématique / Douleur** : Perd des deals stratégiques par manque de maîtrise des nuances linguistiques et des biais culturels.
* **Déclencheur d'Achat questIA** : "Je veux un coaching 1-sur-1 puis des immersions pour dominer nos closing à New York et Londres."

---

## 2. Persona 2 : Alexandre, "Le Tech Founder & Fundraiser"
* **Âge / Posture** : 35 ans, CEO & Co-fondateur d'une DeepTech / IA en levée de fonds Series A/B (5M€).
* **Contexte & Enjeux** : Négocie directement avec des fonds de Venture Capital (VC) américains et britanniques.
* **Problématique / Douleur** : Stressé par la négociation psychologique et le pitch en anglais sous pression.
* **Déclencheur d'Achat questIA** : "J'ai besoin du diagnostic initial avec le Coach pour cadrer mon pitch d'investisseur avant les tests."

---

## 3. Persona 3 : Valérie, "La Directrice Grands Comptes CAC40"
* **Âge / Posture** : 48 ans, Senior Key Account Director dans un grand groupe industriel ou de services (15M€ CA).
* **Contexte & Enjeux** : Fait face à des acheteurs internationaux impitoyables qui utilisent des tactiques de pression psychologique.
* **Problématique / Douleur** : Cherche un bilan comportemental et une finesse de diplomatie d'affaires moderne.
* **Déclencheur d'Achat questIA** : "Je veux un bilan 1-sur-1 avec un Coach avant d'affronter les tests d'immersion."

---

## 4. Persona 4 : Marc, "Le Partner M&A & Consultant de Direction"
* **Âge / Posture** : 50 ans, Associé dans un cabinet de conseil de direction / Fusacq (M&A).
* **Contexte & Enjeux** : Négocie des rachets d'entreprises et des alliances stratégiques internationales.
* **Problématique / Douleur** : Sait que 80% du succès d'une fusion dépend de l'alignement humain et psychologique des dirigeants.
* **Déclencheur d'Achat questIA** : "Un coaching exécutif sur-mesure directement appliqué à mon rachat d'entreprise en cours."
