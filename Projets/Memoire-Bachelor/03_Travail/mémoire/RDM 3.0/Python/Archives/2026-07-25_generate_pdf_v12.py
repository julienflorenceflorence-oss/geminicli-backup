...
async def generate_rdm_pdf():
    ...
    FILE_NAME_HTML = "RAPPORT_DE_MISSION_V12_SOUTENANCE.html"
    FILE_NAME_PDF = f"Rapport de mission V12 SOUTENANCE - {PROMOTION} - {NOM_COMPLET}.pdf"
    ...
    print(f"--- GÉNÉRATEUR PDF V12 SOUTENANCE ---")
