...
pages.append({
    ...
    "content": """
        ...
        <div class="glass-card" style="margin-top: 60px; text-align: center; border: 1px solid #DDA83E; padding: 30px;">
            ...
            <p style="font-size: 10.5pt; color: #DDA83E; margin-top: 5px; font-weight: bold;">ÉDITION V9 SOUTENANCE (ACADÉMIQUE)</p>
...
output_path = os.path.join(base_path, "RAPPORT_DE_MISSION_V9_SOUTENANCE.html")

with open(output_path, "w", encoding="utf-8") as f:
    f.write(final_html)

print(f"[✓] HTML V9 SOUTENANCE généré avec succès ({page_number-1} pages).")
