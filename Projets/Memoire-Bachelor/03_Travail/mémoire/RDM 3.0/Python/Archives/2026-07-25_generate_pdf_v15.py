...
async def generate_rdm_pdf():
    ...
    FILE_NAME_HTML = "RAPPORT_DE_MISSION_V15_SOUTENANCE.html"
    FILE_NAME_PDF = f"Rapport de mission V15 SOUTENANCE - {PROMOTION} - {NOM_COMPLET}.pdf"
    ...
    print(f"--- GÉNÉRATEUR PDF V15 SOUTENANCE ---")
    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            print(f"[OK] Succès ! Le PDF a été généré avec succès : {FILE_NAME_PDF}")
