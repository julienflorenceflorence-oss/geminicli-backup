...
pages.append({
    ...
    "content": """
        <h2>La Matrice de Décision à 6 Niveaux</h2>
...
pages.append({
    ...
    "content": """
        ...
        <ul style="font-size: 10.5pt; line-height: 1.7;">
            ...
            <li><strong>3. La Visibilité Digitale :</strong> Publication d'annonces optimisées pour la réservation directe (sans commission) sur le portail propriétaire du réseau (<em>my-happyhouse.com</em>) ainsi que sur le site partenaire haut de gamme <em>Charme et Caractère</em>, afin de desserrer l'étau des OTAs.</li>
...
pages.append({
    ...
    "content": """
        ...
        <div class="analytic-point">2. Pourquoi isoler ce point</div>
        <div class="analytic-content">L'équation de survie d'un réseau est dictée par la relation entre le Coût d'Acquisition Client (CAC) et la Lifetime Value (LTV). Si les clients entrent par la porte et sortent immédiatement par la fenêtre, le modèle économique est insoutenable à long terme. Il faut comprendre l'abandon avant d'investir en marketing.</div>
...
pages.append({
    ...
    "content": """
        ...
        <div class="analytic-point">6. Le Remède (Scoring Légal & Nurturing)</div>
...
pages.append({
    ...
    "content": """
        ...
        <div class="arbitrage-box" style="margin-top: 30px;">
            ...
            <div class="arbitrage-accepted">
                <strong>Solution retenue : L'Indépendant à fort potentiel (Gros Gîtes & Domaines).</strong> Utiliser l'Agent IA (Gemini Pro) et le croisement Data pour filtrer spécifiquement les particuliers exploitant de belles capacités (Gros gîtes) subissant l'angoisse de la Loi ALUR. Ils ont les volumes pour rentabiliser nos services, mais manquent cruellement d'outils professionnels. Avec eux, nous ne remplaçons pas un outil concurrent : nous comblons un vide vital pour leur survie économique.
            </div>
        </div>
...
pages.append({
    ...
    "content": """
        ...
        <div class="analytic-content">
            ...
            <strong>La Maladie :</strong> La terreur administrative. Elle est la cible directe du couperet de la Loi ALUR (120 jours max, enregistrement) et du DPE. Sans aide d'expert, elle abandonnera le marché par peur des amendes.<br>
            <strong>Le Remède Happy House :</strong> La Professionnalisation comme bouclier de survie. L'Afterwork sera présenté comme une consultation d'urgence pour la mettre aux normes d'exploitation et pérenniser son nouveau patrimoine immobilier.
        </div>
    """
})
...
pages.append({
    ...
    "content": """
        ...
        <p>L'Afterwork Inbound étant le "Remède" absolu à l'échec de la prospection, sa rentabilité (CPA cible < 200€) dépend d'une exécution logistique militaire. La convivialité n'exclut pas le contrôle. Voici le Manuel d'Opérations (SOP) standardisé validé pour maximiser le closing sur site des invités.</p>
...
pages.append({
    ...
    "content": """
        ...
        <p>Le déploiement rigoureux de ce plan d'action hybride sur la prochaine année (Acquisition Inbound + Verrouillage de la Rétention) nécessite un cadrage budgétaire strict validé par la direction :</p>
...
pages.append({
    ...
    "content": """
        ...
        <p style="font-size: 10.5pt; text-align: justify; margin-bottom: 30px;">
            La matrice SWOT confronte les observations du marché (PESTEL) aux réalités comptables et opérationnelles du réseau Happy House. C'est cette matrice qui a mis en lumière la vulnérabilité du modèle (Ratio LTV/CAC) et imposé la répartition des missions de survie (Dashboard de Rétention / Acquisition Inbound de Trafic).
        </p>
...
pages.append({
    ...
    "content": """
        ...
        <div class="expert-note" style="margin-top: 40px; padding: 25px;">
            ...
            Dans ce contexte d'asphyxie, la promesse de service fondatrice de Happy House (Aider l'indépendant à structurer un écosystème web pour ré-internaliser la réservation directe, équilibrer ses leviers de distribution et abaisser ce mix OTA destructeur sous la barre vitale des 35%) n'est pas un argument "marketing". C'est une réponse de <strong>survie financière absolue</strong> à cette distorsion du marché.
        </div>
    """
})
...
# PAGE 43
pages.append({
    "section": "EXTRAITS PIÈCES JUSTIFICATIVES",
    "content": """
        <a id="annexe-11"></a>
...
pages.append({
    ...
    "content": """
        ...
        <div class="glass-card" style="margin-top: 60px; text-align: center; border: 1px solid #DDA83E; padding: 30px;">
            ...
            <p style="font-size: 10.5pt; color: #DDA83E; margin-top: 5px; font-weight: bold;">ÉDITION V8 SOUTENANCE (ACADÉMIQUE)</p>
...
output_path = os.path.join(base_path, "RAPPORT_DE_MISSION_V8_SOUTENANCE.html")

with open(output_path, "w", encoding="utf-8") as f:
    f.write(final_html)

print(f"[✓] HTML V8 SOUTENANCE généré avec succès ({page_number-1} pages).")
