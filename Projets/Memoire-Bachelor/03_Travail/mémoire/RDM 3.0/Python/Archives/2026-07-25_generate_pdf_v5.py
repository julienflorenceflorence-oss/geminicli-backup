...
async def generate_rdm_pdf():
    ...
    FILE_NAME_HTML = "RAPPORT_DE_MISSION_V5_EXPERT_LONG.html"
    FILE_NAME_PDF = f"Rapport de mission V5 EXPERT LONG - {PROMOTION} - {NOM_COMPLET}.pdf"
    ...
    print(f"--- GÉNÉRATEUR PDF V5 EXPERT LONG ---")
