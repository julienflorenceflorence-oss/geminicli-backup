...
async def generate_rdm_pdf():
    ...
    FILE_NAME_HTML = "RAPPORT_DE_MISSION_V9_SOUTENANCE.html"
    FILE_NAME_PDF = f"Rapport de mission V9 SOUTENANCE - {PROMOTION} - {NOM_COMPLET}.pdf"
    ...
    print(f"--- GÉNÉRATEUR PDF V9 SOUTENANCE ---")
