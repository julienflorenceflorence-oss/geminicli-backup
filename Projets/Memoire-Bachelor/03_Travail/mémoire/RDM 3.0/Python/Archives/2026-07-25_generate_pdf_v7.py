...
async def generate_rdm_pdf():
    ...
    FILE_NAME_HTML = "RAPPORT_DE_MISSION_V7_MASTODONTE.html"
    FILE_NAME_PDF = f"Rapport de mission V7 MASTODONTE - {PROMOTION} - {NOM_COMPLET}.pdf"
    ...
    print(f"--- GÉNÉRATEUR PDF V7 MASTODONTE ---")
