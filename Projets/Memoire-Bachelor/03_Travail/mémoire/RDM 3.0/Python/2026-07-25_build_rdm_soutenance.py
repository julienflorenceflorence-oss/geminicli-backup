...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
        ...
        .glass-card { background: rgba(255, 255, 255, 0.05); border: 1px solid var(--border-glass); padding: 15px; border-radius: 4px; margin: 20px 0; position: relative; }
        ...
        .table-compact { width: 100%; border-collapse: collapse; margin: 8px 0; font-size: 8pt; line-height: 1.35; }
        .table-compact th { padding: 6px 8px; font-size: 8.5pt; background: rgba(221, 168, 62, 0.15); color: var(--gold); border: 1px solid var(--border-glass); text-align: left; }
        .table-compact td { padding: 5px 8px; font-size: 8pt; border: 1px solid var(--border-glass); color: #fff; vertical-align: top; }
...
# --- PAGE 2 : SOMMAIRE ---
sommaire_html = """
    <a id="sommaire-anchor"></a><h1 style="color: #DDA83E; text-align: center;">Sommaire Analytique Général</h1>
    <div style="margin-top: 20px;">
"""
chapitres = [
    ("EXECUTIVE SUMMARY (SYNTHÈSE)", "EXECUTIVE SUMMARY"),
    ("PRÉAMBULE : LE RÉFÉRENTIEL D'ARBITRAGE", "PRÉAMBULE MÉTHODOLOGIQUE"),
    ("LEXIQUE & ACRONYMES", "LEXIQUE & ACRONYMES"),
    ("I. L'ENTREPRISE & LA PROBLÉMATIQUE", "CHAPITRE 1 : L'ENTREPRISE"),
    ("II. LE MARCHÉ : LA FATIGUE NUMÉRIQUE", "CHAPITRE 2 : LE MARCHÉ"),
    ("III. AUDIT INTERNE : LA VULNÉRABILITÉ DU MODÈLE", "CHAPITRE 3 : AUDIT INTERNE"),
    ("IV. AUDIT DATA : LE FILTRE LÉGAL ALUR (126k LEADS)", "CHAPITRE 4 : AUDIT DATA & LOI ALUR"),
    ("V. AUDIT ACQUISITION : LIMITES DE L'OUTBOUND", "CHAPITRE 5 : AUDIT ACQUISITION"),
    ("VI. L'ANATOMIE DU PIVOT INBOUND & PRICING", "CHAPITRE 6 : L'ANATOMIE DU PIVOT"),
    ("VII. LA RÉTENTION : DÉPLOIEMENT DU DASHBOARD", "CHAPITRE 7 : LA RÉTENTION"),
    ("VIII. LE PLAN D'ACTION (BUDGET M12 & COPIL)", "CHAPITRE 8 : LE PLAN D'ACTION"),
    ("IX. PLAN DE CARRIÈRE & BILAN PERSONNEL", "CHAPITRE 9 : BILAN & PROFIL"),
    ("X. DÉCLARATION DE CONFORMITÉ IA", "CHAPITRE 10 : CONFORMITÉ IA"),
    ("XI. ANNEXES PHYSIQUES & MATRICES", "ANNEXE 1 : MATRICE PESTEL (PARTIE 1)"),
    ("XII. EXTRAITS & DOSSIER DRIVE SÉCURISÉ", "ANNEXE 11 : EXTRAITS PIÈCES JUSTIFICATIVES")
]
for titre, section_ref in chapitres:
    sommaire_html += f"""
        <a href="#page-{{{{PAGE_{section_ref}}}}}" class="toc-link">
            <table style="width: 100%; border: none; margin: 0;"><tr>
                <td style="border: none; padding: 0; color: #FFFFFF;">{titre}</td>
                <td style="border: none; padding: 0; text-align: right; color: #DDA83E;">{{{{PAGE_{section_ref}_PAD}}}}</td>
            </tr></table>
        </a>
    """
sommaire_html += """
...
pages.append({
    ...
    "content": """
        <h1>Remerciements & Cadre Analytique <a href="#sommaire-anchor" class="btn-sommaire">Retour au Sommaire</a></h1>
        ...
        <h2>L'Exigence du Conseil & Rigueur Méthodologique</h2>
        <p>Ce rapport stratégique rompt avec la narration descriptive pour adopter une posture clinique d'auditeur. Afin de répondre aux standards de rigueur scientifique et d'honnêteté académique, deux limites fondamentales liées à nos données doivent être explicitées d'emblée :</p>
        <div class="expert-note" style="margin-top: 10px; font-size: 9.5pt; padding: 10px 15px; border-left: 4px solid var(--gold); background: rgba(221, 168, 62, 0.05);">
            <strong>1. Biais de l'échantillon qualitatif (Confrontation terrain) :</strong> Les conclusions sur les frictions opérationnelles des hôtes reposent sur un panel qualitatif de ~30 interlocuteurs. Bien que ces données révèlent des signaux faibles solides, l'échantillon présente un biais d'auto-sélection (les exploitants ayant accepté de nous accorder du temps présentaient déjà une sensibilité aux problématiques de distribution). Ces résultats ne doivent donc pas être extrapolés à la totalité des indépendants passifs.<br>
            <strong>2. Reconstruction de l'Attrition historique (Churn) :</strong> L'absence de CRM structuré ou d'outils de tracking clients lors de ma prise de poste a nécessité une reconstruction empirique des données à partir de l'historique comptable. Les 80% de "silence radio" constatés sur la cohorte Outbound intègrent ainsi sans distinction les cessations d'activité réelles, les ventes d'établissements et les départs à la retraite. Ce chiffre constitue un indicateur de perte de relation réseau, et non une mesure exclusive d'insatisfaction.
        </div>
    """
})
...
pages.append({
    ...
    "content": """
        <h1>Lexique et Acronymes <a href="#sommaire-anchor" class="btn-sommaire">Retour au Sommaire</a></h1>
...
pages.append({
    ...
    "content": """
        <a id="chapitre-1"></a>
        <h1>Chapitre 1 — L'Entreprise & La Problématique <a href="#sommaire-anchor" class="btn-sommaire">Retour au Sommaire</a></h1>
        ...
        <ul style="font-size: 10.5pt; line-height: 1.7;">
            <li><strong>1. L'Optimisation Financière :</strong> Accès à la centrale d'achats <em>Entegra</em> pour attaquer les postes opérationnels qui pèsent jusqu'à <strong>45% des charges</strong> de l'hébergeur et viser une augmentation de <strong>10 à 20% de sa marge nette</strong>.</li>
            <li><strong>2. L'Infrastructure Tech :</strong> Déploiement d'une application (Guest App) et d'un CRM pour libérer <strong>10 à 15 heures par semaine</strong> à l'exploitant en automatisant les tâches de communication client.</li>
...
pages.append({
    ...
    "content": """
        <a id="chapitre-2"></a>
        <h1>Chapitre 2 — Le Diagnostic Externe : La Fatigue Numérique <a href="#sommaire-anchor" class="btn-sommaire">Retour au Sommaire</a></h1>
...
pages.append({
    ...
    "content": """
        <a id="chapitre-3"></a>
        <h1>Chapitre 3 — Audit Interne : La Vulnérabilité du Modèle <a href="#sommaire-anchor" class="btn-sommaire">Retour au Sommaire</a></h1>
...
pages.append({
    ...
    "content": """
        <a id="chapitre-4"></a>
        <h1>Chapitre 4 — L'Audit Data : Le Filtre Légal (ALUR) <a href="#sommaire-anchor" class="btn-sommaire">Retour au Sommaire</a></h1>
...
pages.append({
    ...
    "content": """
        <a id="chapitre-5"></a>
        <h1>Chapitre 5 — Audit d'Acquisition : L'Impasse Outbound <a href="#sommaire-anchor" class="btn-sommaire">Retour au Sommaire</a></h1>
...
pages.append({
    ...
    "content": """
        <a id="chapitre-6"></a>
        <h1>Chapitre 6 — Le Pivot Stratégique : Les Personas & Le Pricing <a href="#sommaire-anchor" class="btn-sommaire">Retour au Sommaire</a></h1>
...
pages.append({
    ...
    "content": """
        <h2>Arbitrage Stratégique face à l'Automatisation de Masse</h2>

        <div class="analytic-point">Mon arbitrage face au veto de la Direction (Maturité managériale)</div>
        <div class="analytic-content">En tant que Growth Marketer, j'ai d'abord conçu et prototypé une automatisation complète (via n8n) pour traiter nos 126k Leads par du <em>Cold Emailing</em>. Bien que techniquement et financièrement performante sur le papier, la direction a opposé un veto ferme, redoutant l'assimilation à du spam et la dégradation de l'image de marque (Brand Damage). Plutôt que de forcer une solution purement technique, j'ai pris la responsabilité d'arbitrer en faveur d'un pivot vers le relationnel : exploiter notre puissance de ciblage Data pour inviter des profils hyper-qualifiés à des Afterworks physiques. Ce choix démontre que si l'IA a servi d'accélérateur pour le ciblage, la décision stratégique finale et la relation humaine ont été pilotées par mon analyse.</div>
        
        <div class="analytic-point">La Maladie (Le Risque de Dégradation d'Image)</div>
        <div class="analytic-content">La saturation des boîtes mail des hébergeurs génère un rejet pavlovien. Utiliser l'Outbound automatique dans un marché déjà hostile à la prospection (97% de rejet), c'est risquer d'aligner Happy House sur les pratiques industrielles intrusives. L'événement physique devient la seule réassurance possible.</div>
...
pages.append({
    ...
    "content": """
        <a id="chapitre-7"></a>
        <h1>Chapitre 7 — La Rétention : Le Dashboard R.O.I <a href="#sommaire-anchor" class="btn-sommaire">Retour au Sommaire</a></h1>
...
pages.append({
    ...
    "content": """
        <a id="chapitre-8"></a>
        <h1>Chapitre 8 — Plan d'Action, Guide Logistique & COPIL <a href="#sommaire-anchor" class="btn-sommaire">Retour au Sommaire</a></h1>
...
pages.append({
    ...
    "content": """
        <a id="chapitre-9"></a>
        <h1>Chapitre 9 — Bilan Personnel & CV Digital <a href="#sommaire-anchor" class="btn-sommaire">Retour au Sommaire</a></h1>
...
pages.append({
    ...
    "content": """
        <a id="chapitre-10"></a>
        <h1>Chapitre 10 — Déclaration de Conformité IA <a href="#sommaire-anchor" class="btn-sommaire">Retour au Sommaire</a></h1>
...
# PAGE 34
pages.append({
    "section": "ANNEXE 1 : MATRICE PESTEL (PARTIE 1)",
    "content": """
        <a id="annexe-1"></a>
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 1 : L'Analyse Macro (PESTEL — 1/2)</h1>
        
        <p style="font-size: 9.5pt; text-align: justify; margin-bottom: 10px;">
            Cet outil d'analyse macro-environnementale modélise les pressions externes qui s'exercent sur les hébergeurs indépendants en 2024-2026, justifiant la pertinence structurelle de l'offre Happy House.
        </p>

        <table class="table-compact">
            <tr style='background: rgba(221, 168, 62, 0.2);'><th style='width: 25%;'>Dimension Macro</th><th>Analyse des Forces Sectorielles et Impact Réseau Happy House</th></tr>
            <tr>
                <td><strong>P — Politique & Légal</strong></td>
                <td>Application extrêmement stricte de la **Loi anti-Airbnb & Loi ALUR** (décret passoires thermiques DPE G en 2025, quotas municipaux, plafonnement stricts à 120 jours). Ce durcissement réglementaire provoque une purge massive (20-25% de baisse du parc de location de loisirs amateurs). <br><em style="color: var(--gold);">Impact Stratégique : Les loueurs font face à une menace d'interdiction. Notre ciblage de particuliers (70% de la base) se positionne comme l'unique solution d'accompagnement vers la professionnalisation.</em></td>
            </tr>
            <tr>
                <td><strong>E — Économique</strong></td>
                <td>Hyper-inflation des charges fixes d'exploitation (+15% d'augmentation sur l'énergie en 2024, hausse brutale des coûts blanchisserie et matières premières F&B), érodant la rentabilité des domaines. <br><em style="color: var(--gold);">Impact Stratégique : Le cost-killing est le levier d'acquisition numéro un. L'offre centrale d'achat Entegra garantit un ROI immédiat et factuel qui brise le silence commercial lors du démarchage.</em></td>
            </tr>
            <tr>
                <td><strong>S — Socioculturel</strong></td>
                <td>Évolution des attentes des voyageurs B2C vers le **Slow Tourism** et la recherche d'expériences "authentiques, locales et de caractère", fuyant les hébergements standardisés de masse. <br><em style="color: var(--gold);">Impact Stratégique : Validation absolue de notre ciblage "Premium & Charme" ; nos membres détiennent l'inventaire le plus désirable, mais manquent de visibilité et d'outils pour le valoriser.</em></td>
            </tr>
        </table>
    """
})
...
# PAGE 35
pages.append({
    "section": "ANNEXE 1 : MATRICE PESTEL (PARTIE 2)",
    "content": """
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 1 : L'Analyse Macro (PESTEL — 2/2)</h1>
        
        <p style="font-size: 9.5pt; text-align: justify; margin-bottom: 10px;">
            Suite de l'analyse macro-environnementale modélisant l'étouffement technologique et la transition écologique subis par nos prospects.
        </p>

        <table class="table-compact">
            <tr style='background: rgba(221, 168, 62, 0.2);'><th style='width: 25%;'>Dimension Macro</th><th>Analyse des Forces Sectorielles et Impact Réseau Happy House</th></tr>
            <tr>
                <td><strong>T — Technologique</strong></td>
                <td>Oligopole prédateur des grandes OTAs (Booking, Airbnb, Expedia) captant 71% des réservations en ligne. Le leader Booking.com s'octroie 69,3% de ce flux, imposant des commissions de 15% à 25% et confisquant l'accès direct aux clients. <br><em style="color: var(--gold);">Impact Stratégique : L'hébergeur indépendant est captif de l'algorithme. Happy House l'outille pour ré-internaliser la clientèle directe (abaisser le mix OTA sous les 35%) et évite la sollicitation à froid abrasive au profit des Afterworks relationnels.</em></td>
            </tr>
            <tr>
                <td><strong>E — Écologique</strong></td>
                <td>Pression environnementale forte des institutions locales et forte demande de certification durable de la part des clientèles haut de gamme internationales (**Clef Verte +184% d'établissements labellisés**). <br><em style="color: var(--gold);">Impact Stratégique : Atout de valorisation majeur pour nos membres premium, mais génère une fatigue administrative complexe que nos alternants viennent accompagner et soulager.</em></td>
            </tr>
        </table>
    """
})
...
# PAGE 36
pages.append({
    "section": "ANNEXE 2 : MATRICE SWOT (PARTIE 1)",
    "content": """
        <a id="annexe-2"></a>
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 2 : Le Diagnostic Croisé (SWOT — 1/2)</h1>
        
        <p style="font-size: 9.5pt; text-align: justify; margin-bottom: 10px; line-height: 1.4;">
            Le SWOT confronte les observations du marché (PESTEL) aux réalités comptables et opérationnelles du réseau. Première partie : Diagnostic interne des forces et faiblesses.
        </p>

        <table class="table-compact">
            <tr style='background: rgba(221, 168, 62, 0.2);'>
                <th style='width: 50%;'>FORCES (Capacités Internes)</th>
                <th style='width: 50%; color: #E74C3C;'>FAIBLESSES (Failles Internes)</th>
            </tr>
            <tr>
                <td style='line-height: 1.4;'>
                    <strong>1. Alliance Entegra :</strong> Contrat exclusif validé avec la centrale d'achats globale, offrant des remises immédiates de 15-25% (F&B, énergie, blanchisserie). Gains de 4 120€ mesurés (Cas Durentie).<br><br>
                    <strong>2. L'Actif Data :</strong> Base propriétaire unique de 126k contacts qualifiés, permettant un ciblage chirurgical par zones géographiques.<br><br>
                    <strong>3. Image Premium :</strong> Positionnement qualitatif "Premium & Charme" validé, réseau actif de 170 membres historiques.
                </td>
                <td style='line-height: 1.4; color: #fff;'>
                    <strong>1. CAC Astronomique :</strong> Coût d'Acquisition Client Outbound à 1 823€ (SDR dédié au démarchage pour 1 signature/mois) face à un ARPU de 226€/an (LTV/CAC effondré à 0,16).<br><br>
                    <strong>2. Attrition Outbound :</strong> Taux de churn critique de 80% sur la cohorte acquise à froid. L'absence de relationnel produit des clients instables.<br><br>
                    <strong>3. Déficit de Preuve ROI :</strong> Absence de reporting ou de Dashboard permettant de matérialiser les gains Entegra pour le membre.
                </td>
            </tr>
        </table>
    """
...
# PAGE 37
pages.append({
    "section": "ANNEXE 2 : MATRICE SWOT (PARTIE 2)",
    "content": """
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 2 : Le Diagnostic Croisé (SWOT — 2/2)</h1>
        
        <p style="font-size: 9.5pt; text-align: justify; margin-bottom: 10px; line-height: 1.4;">
            Deuxième partie du SWOT : Confrontation des opportunités de croissance et des menaces externes pesant sur Happy House.
        </p>

        <table class="table-compact">
            <tr style='background: rgba(221, 168, 62, 0.2);'>
                <th style='width: 50%; color: #2ECC71;'>OPPORTUNITÉS (Leviers Externes)</th>
                <th style='width: 50%; color: #E74C3C;'>MENACES (Risques Externes)</th>
            </tr>
            <tr>
                <td style='line-height: 1.4;'>
                    <strong>1. Pression ALUR/DPE :</strong> Marché captif de propriétaires obligés de se professionnaliser pour maintenir la rentabilité locative.<br><br>
                    <strong>2. Inflation des Exploitations :</strong> L'explosion des charges d'énergie et de nourriture rend l'offre cost-killing Entegra de Happy House indispensable.<br><br>
                    <strong>3. Afterworks Relationnels :</strong> Modèle Inbound valorisant le contact de proximité, ramenant le CPA à 166€ et renforçant la rétention.
                </td>
                <td style='line-height: 1.4;'>
                    <strong>1. Oligopole OTAs :</strong> Monopole de Booking (71% parts de marché), augmentant la dépendance et érodant les marges des indépendants.<br><br>
                    <strong>2. Fatigue Numérique :</strong> Rejet brutal par les prospects de la prospection téléphonique de masse, nuisant à l'image de marque (Brand Damage).
                </td>
            </tr>
        </table>
    """
...
# PAGE 38
pages.append({
    "section": "ANNEXE 3 : FORCES DE PORTER (PARTIE 1)",
    "content": """
        <a id="annexe-3"></a>
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 3 : Les 5 Forces de Porter (1/2)</h1>
        
        <p style="font-size: 9.5pt; text-align: justify; margin-bottom: 10px; line-height: 1.4;">
            Modélisation des rapports de force concurrentiels. Première partie : Intensité concurrentielle interne, Nouveaux Entrants et Pouvoir des clients intermédiaires (OTAs).
        </p>

        <table class="table-compact">
            <tr style='background: rgba(221, 168, 62, 0.2);'>
                <th style='width: 30%;'>Force Concurrentielle</th>
                <th style='width: 15%; text-align: center;'>Intensité</th>
                <th>Analyse Analytique et Justification Stratégique</th>
            </tr>
            <tr>
                <td><strong>Intensité Concurrentielle</strong></td>
                <td style="color: #E74C3C; font-weight: bold; text-align: center;">Forte<br>(4/5)</td>
                <td>Marché saturé de logiciels PMS, channel managers et conseils. L'hébergeur Premium est sur-sollicité et rejette les démarches commerciales froides, imposant à Happy House de se différencier par des relations de confiance locales physiques (Afterworks).</td>
            </tr>
            <tr>
                <td><strong>Menace des Nouveaux Entrants</strong></td>
                <td style="color: #2ECC71; font-weight: bold; text-align: center;">Faible<br>(2/5)</td>
                <td>Cibler le segment Premium & Charme requiert une double expertise (hôtelière et technologique) ainsi que des bases de données volumineuses. Le ticket d'entrée intellectuel et notre réseau de 170 membres créent de fortes barrières.</td>
            </tr>
            <tr>
                <td><strong>Pouvoir des Clients (OTAs)</strong></td>
                <td style="color: #E74C3C; font-weight: bold; text-align: center;">Très Fort<br>(5/5)</td>
                <td>Booking/Airbnb captent 71% des flux de voyageurs. L'hébergeur indépendant est captif de cet algorithme et subit des commissions (15-25%). Happy House aide à ré-internaliser la clientèle directe pour baisser le mix OTA sous 35%.</td>
            </tr>
        </table>
    """
})
...
# PAGE 39
pages.append({
    "section": "ANNEXE 3 : FORCES DE PORTER (PARTIE 2)",
    "content": """
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 3 : Les 5 Forces de Porter (2/2)</h1>
        
        <p style="font-size: 9.5pt; text-align: justify; margin-bottom: 10px; line-height: 1.4;">
            Deuxième partie de l'analyse sectorielle : Pouvoir de négociation des fournisseurs et Menace des produits de substitution.
        </p>
        ...
        <table class="table-compact">
            ...
            <tr>
                ...
                <td style="color: #F1C40F; font-weight: bold; text-align: center;">Moyen-Fort<br>(3,5/5)</td>
                <td>Les fournisseurs d'énergie, de blanchisserie et de F&B profitent de l'inflation pour imposer leurs tarifs. Seule, une petite maison d'hôtes subit ; la centrale d'achats Entegra regroupe les volumes Happy House pour rétablir le rapport de force.</td>
            </tr>
            <tr>
                <td><strong>Menace des Substituts</strong></td>
                <td style="color: #F1C40F; font-weight: bold; text-align: center;">Moyenne<br>(3/5)</td>
                <td>L'hôtellerie standardisée industrielle offre des tarifs plus bas et une distribution puissante. Nos membres indépendants doivent valoriser leur "supplément d'âme" Premium & Charme pour s'en extraire.</td>
            </tr>
        </table>
    """
})
...
pages.append({
    ...
    "content": """
        <a id="annexe-4"></a>
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 4 : Les Limites de l'Outbound</h1>
        
        <p style="font-size: 9.5pt; text-align: justify; margin-bottom: 10px;">
            Modélisation comptable stricte démontrant que la stratégie Outbound initiale (Le Démarchage) est "inopérante" face à la rentabilité projetée du pivot stratégique Inbound.
        </p>

        <div class="visual-block" style="border-color: #E74C3C; padding: 12px; margin-bottom: 15px;">
            <div class="visual-title" style="color: #E74C3C; font-size: 10pt; margin-bottom: 8px;">1. LE DÉFICIT STRUCTUREL : L'OUTBOUND (Cold Calling)</div>
            
            <p style="color: #FFF; font-size: 9.5pt; margin-top: 5px; margin-bottom: 5px;"><strong>L'Audit du Tunnel d'Acquisition (SDR) :</strong></p>
            <div class="code-line" style="font-size: 9pt; line-height: 1.45;">- <strong>Le Coût Salarial SDR mensuel :</strong> 1 823 € nets (Exonéré de cotisations patronales). L'effort d'appels à froid occupe 100% de la ressource.</div>
            <div class="code-line" style="font-size: 9pt; margin-top: 5px; line-height: 1.45;">- <strong>L'Effort Métrique Brut Audité :</strong> <strong>14 500 appels</strong> sur 48 semaines (300/semaine). Génère 50% de non-réponse et 40% de refus francs.</div>
            <div class="code-line" style="font-size: 9pt; margin-top: 5px; line-height: 1.45;">- <strong>Conversion :</strong> Seulement <strong>1 seule signature / mois</strong>. CAC = 1 823 € par Membre.</div>
            
            <div style="background: rgba(231, 76, 60, 0.15); padding: 10px; margin-top: 10px; border-left: 4px solid #E74C3C;">
                <div class="code-line" style="color: #E74C3C; font-weight: bold; font-size: 11pt;">=> Coût d'Acquisition Client (CAC) Fixé : 1 823 € par Membre.</div>
                
                <div style="background: rgba(255,255,255,0.03); border: 1px dashed rgba(231, 76, 60, 0.3); padding: 8px; margin-top: 8px; font-size: 8.5pt;">
                    <strong style="color: #E74C3C; display: block; margin-bottom: 2px;">CALCUL :</strong>
                    <span style="font-family: 'Courier New', Courier, monospace; color: #FFF; display: block;">
                    (Salaire SDR 1766€ + Outils 57€) / 1 signature = 1 823 €.
                    </span>
                </div>
                <div class="code-line" style="color: #FFF; font-size: 9pt; margin-top: 8px; line-height: 1.45;"><em>Note : Avec un ARPU à 226€/an, et une LTV de 290€ (dû au Churn), le ratio LTV/CAC s'effondre à 0,16. Non-viable.</em></div>
            </div>
        </div>

        <div class="visual-block" style="border-color: #2ECC71; padding: 12px;">
            <div class="visual-title" style="color: #2ECC71; font-size: 10pt; margin-bottom: 8px;">2. LE MODÈLE DE SAUVETAGE : INBOUND (Afterworks Régionaux)</div>
            
            <p style="color: #FFF; font-size: 9.5pt; margin-top: 5px; margin-bottom: 5px;"><strong>Variables de modélisation (Crash-Test) :</strong></p>
            <div class="code-line" style="font-size: 9pt; line-height: 1.45;">- <strong>Budget :</strong> <strong>500 € par événement</strong> (Traiteur, Logistique) pour 30 prospects qualifiés "Conformes ALUR".</div>
            <div class="code-line" style="font-size: 9pt; margin-top: 5px; line-height: 1.45;">- <strong>Objectif :</strong> 10% de conversion, soit <strong>3 signatures par événement</strong>. CPA = 166 € par Membre.</div>
            
            <div style="background: rgba(46, 204, 113, 0.15); padding: 10px; margin-top: 10px; border-left: 4px solid #2ECC71;">
                <div class="code-line" style="color: #2ECC71; font-weight: bold; font-size: 11pt;">=> Coût Par Acquisition (CPA) Projeté : 166 € par Membre.</div>
                <div class="code-line" style="color: #FFF; font-size: 9pt; margin-top: 8px; line-height: 1.45;"><em>Note : Le CPA descend sous l'ARPU (226€). Arithmétique viable avec les prix actuels.</em></div>
            </div>
        </div>
    """
})
...
pages.append({
    ...
    "content": """
        <a id="annexe-5"></a>
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 5 & 10 : Attrition & Rentabilité Nette</h1>
        
        <h2 style='font-size: 11.5pt; color: #E74C3C; margin-bottom: 6px;'>Annexe 5 : Le Bilan de l'Attrition Outbound</h2>
        <p style='font-size: 9.5pt; text-align: justify; line-height: 1.45; margin-bottom: 10px;'>L'audit du portefeuille a révélé un <strong>"Silence Radio" massif de 80% sur la cohorte d'acquisition Outbound (146 dossiers)</strong>, limitant la LTV à 290€. Ce contraste avec la stabilité du réseau historique (170 membres organiques) prouve que l'Outbound génère une clientèle infidèle. La mise en place du Dashboard ROI et de l'Inbound est la réponse à cette vulnérabilité.</p>

        <a id="annexe-10"></a>
        <h2 style='font-size: 11.5pt; color: #2ECC71; margin-top: 15px; margin-bottom: 6px;'>Annexe 10 : La Validation Comptable (Cas Durentie)</h2>
        <p style='font-size: 9.5pt; text-align: justify; line-height: 1.45; margin-bottom: 10px;'>Simulation comptable certifiée d'un domaine Premium suite à son adhésion (Application des remises Entegra). C'est la "Master Data" qui alimente le Dashboard.</p>

        <table class="table-compact">
            <tr style='background: rgba(221, 168, 62, 0.2);'><th style='width: 60%;'>Poste Financier Analysé</th><th style='text-align: right;'>Impact Mesuré (€)</th></tr>
            <tr><td style='padding: 6px 8px;'><strong>L'Investissement Initial</strong> (Cotisation réseau)</td><td style="color: #E74C3C; font-weight: bold; padding: 6px 8px; text-align: right;">- 360,00 €</td></tr>
            <tr><td style='padding: 6px 8px;'><strong>Économies F&B (Alimentation & Boissons)</strong> (Remises Entegra 15%)</td><td style="color: #2ECC71; padding: 6px 8px; text-align: right;">+ 2 150,00 €</td></tr>
            <tr><td style='padding: 6px 8px;'><strong>Économies d'Énergie</strong> (Bouclier tarifaire du réseau)</td><td style="color: #2ECC71; padding: 6px 8px; text-align: right;">+ 1 420,00 €</td></tr>
            <tr><td style='padding: 6px 8px;'><strong>Économies Blanchisserie / Équipement</strong></td><td style="color: #2ECC71; padding: 6px 8px; text-align: right;">+ 910,00 €</td></tr>
            <tr style='border-top: 1px solid var(--gold); background: rgba(255,255,255,0.03);'>
                <td style='padding: 6px 8px;'><strong>BÉNÉFICE NET STRICTEMENT OPÉRATIONNEL</strong> (Économies passives nettes)</td>
                <td style="color: var(--gold); font-weight: bold; padding: 6px 8px; text-align: right;">+ 4 120,00 €</td>
            </tr>
            <tr><td style='padding: 6px 8px;'><strong>Le Chiffre d'Affaires Actif Généré</strong> (Clientèle inter-réseau)</td><td style="color: #2ECC71; padding: 6px 8px; text-align: right;">+ 11 000,00 €</td></tr>
            <tr style='background: rgba(46, 204, 113, 0.1); border-top: 2px solid #2ECC71;'>
                <td style='padding: 8px; font-weight: bold;'>IMPACT GLOBAL (A+B) SUR LA TRÉSORERIE</td>
                <td style='padding: 8px; text-align: right;'><strong style="color: #2ECC71; font-size: 11pt;">+ 15 120,00 €</strong></td>
            </tr>
        </table>
    """
})
...
pages.append({
    ...
    "content": """
        <a id="annexe-6"></a>
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 6 & 7 : Le Pivot du Script SDR</h1>
        
        <p style="font-size: 9.5pt; text-align: justify; margin-bottom: 10px; line-height: 1.4;">Le SDR Younes a été formé à une méthodologie de <strong>"Sélection Inbound et Profilage"</strong> (invitation VIP Afterwork via le fichier data de 126k contacts) pour remplacer la prospection Outbound abrasive.</p>

        <div class='glass-card' style='font-size: 9.5pt; padding: 15px;'>
            <div class="visual-title" style="color: var(--gold); font-size: 11pt; margin-bottom: 10px;">TRAME DE QUALIFICATION (Extrait)</div>
            
            <p style='margin-top: 5px; color: #FFF; font-size: 9.5pt;'><strong>ÉTAPE 1 : L'ACCROCHE (Désamorcer le bouclier commercial)</strong><br>
            <span style='color: #FFFFFF; font-size: 9pt; line-height: 1.4;'><em style='color: #A9B7C6; display: block; background: rgba(0,0,0,0.3); padding: 8px; margin-top: 5px; border-left: 3px solid #A9B7C6;'>« Bonjour [Prénom], c’est Younes, sélection Happy House. Nous organisons un événement privé à huis clos pour les meilleurs hébergeurs premium de [Région]. Votre profil correspond exactement à notre filtre d'invités. »</em></span></p>
            
            <p style='margin-top: 10px; color: #FFF; font-size: 9.5pt;'><strong>ÉTAPE 2 : LA QUALIFICATION PSYCHOLOGIQUE (DISC)</strong><br>
            <span style='color: #FFFFFF; font-size: 9pt; line-height: 1.4;'>
            <strong>A : Profil Dominant (D) / Rationnel</strong> (Angoissé par ses marges et l'inflation) :<br>
            <em style='color: #A9B7C6; display: block; background: rgba(0,0,0,0.3); padding: 8px; margin-top: 3px; border-left: 3px solid #E74C3C;'>« L'objectif sera d'aborder avec des chiffres réels les leviers pour contrer l'inflation et abaisser vos charges via notre centrale Entegra. »</em><br>
            <strong>B : Profil Influent (I) / Relationnel</strong> (Souffrant de l'isolement du dirigeant) :<br>
            <em style='color: #A9B7C6; display: block; background: rgba(0,0,0,0.3); padding: 8px; margin-top: 3px; border-left: 3px solid #2ECC71;'>« Ce format en petit comité sera l'occasion d'échanger avec vos pairs sur notre complexité commune : gérer la dépendance à Booking. »</em></span></p>
            
            <p style='margin-top: 10px; color: #FFF; font-size: 9.5pt;'><strong>ÉTAPE 3 : LA CLÔTURE (FOMO)</strong><br>
            <span style='color: #FFFFFF; font-size: 9pt; line-height: 1.4;'><em style='color: #A9B7C6; display: block; background: rgba(0,0,0,0.3); padding: 8px; margin-top: 5px; border-left: 3px solid var(--gold);'>« L'accès est gratuit et sur invitation privée. Si cela fait sens, je vous envoie le lien. Vous pourrez y croiser [Nom d'un domaine membre prestigieux] qui sera présent. On bloque votre place ? »</em></span></p>
        </div>
    """
})
...
pages.append({
    ...
    "content": """
        <a id="annexe-8"></a>
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 8 : Outils Opérationnels (CRM & Emails)</h1>
        
        <p style="font-size: 9.5pt; text-align: justify; margin-bottom: 10px; line-height: 1.4;">Cette annexe matérialise l'ingénierie opérationnelle développée pour soutenir le pivot : scoring CRM et nurturing institutionnel local.</p>

        <h2 style='font-size: 11pt; margin-top: 10px; margin-bottom: 5px; color: var(--gold-light);'>1. Le Scoring CRM (L'Interface de Pilotage SDR)</h2>
        <div class="visual-block" style="border-color: #2ECC71; padding: 10px; margin-bottom: 10px;">
            <div class="visual-title" style="color: #2ECC71; font-size: 9.5pt; margin-bottom: 5px;">EXTRAIT INTERFACE CRM (QUALIFICATION & TAGS)</div>
            <table style="width: 100%; border-collapse: collapse; font-size: 8.5pt; margin-top: 5px;">
                <tr style="background: rgba(255,255,255,0.05);"><th style="padding: 4px;">ALUR</th><th style="padding: 4px;">Domaine</th><th style="padding: 4px;">⭐</th><th style="padding: 4px;">Dép.</th><th style="padding: 4px;">Tag (Qualification)</th></tr>
                <tr><td style="color: #fd7e14; font-weight: bold; padding: 3px 4px;">PARTICULIER</td><td style="padding: 3px 4px;">Les Caudalies</td><td style="padding: 3px 4px;">⭐⭐⭐</td><td style="padding: 3px 4px;">39</td><td style="color: #28a745; padding: 3px 4px;">SUIVI NÉGO (Potentiel)</td></tr>
                <tr><td style="color: #28a745; font-weight: bold; padding: 3px 4px;">PROFESSIONNEL</td><td style="padding: 3px 4px;">Hostellerie Bretonnière</td><td style="padding: 3px 4px;">⭐⭐⭐</td><td style="padding: 3px 4px;">21</td><td style="color: #28a745; padding: 3px 4px;">SUIVI NÉGO (Potentiel)</td></tr>
                <tr><td style="color: #fd7e14; font-weight: bold; padding: 3px 4px;">PARTICULIER</td><td style="padding: 3px 4px;">Chalet forêt</td><td style="padding: 3px 4px;">⭐⭐⭐</td><td style="padding: 3px 4px;">25</td><td style="color: #ffc107; padding: 3px 4px;">REFUS ARGU (Surchargé)</td></tr>
                <tr><td style="color: #28a745; font-weight: bold; padding: 3px 4px;">PROFESSIONNEL</td><td style="padding: 3px 4px;">Annexe du 11 C</td><td style="padding: 3px 4px;">⭐⭐⭐</td><td style="padding: 3px 4px;">25</td><td style="color: #dc3545; padding: 3px 4px;">REFUS CATÉ (Outbound)</td></tr>
            </table>
        </div>

        <h2 style='font-size: 11pt; margin-top: 10px; margin-bottom: 5px; color: var(--gold-light);'>2. Le Nurturing (L'Échauffement du Lead)</h2>
        <div class="glass-card" style="padding: 10px 15px; font-size: 8.5pt; margin-top: 5px;">
            <div class="visual-title" style="color: var(--gold); font-size: 9.5pt; margin-bottom: 5px;">TEMPLATE PROSPECTION : LEVIER INSTITUTIONNEL</div>
            <p style="color: var(--text-muted); margin-bottom: 5px;"><strong>Objet :</strong> Partenariat Excellence Locale - Événement Happy House [Région]<br><strong>Cible :</strong> Responsable Hébergement (Office du Tourisme)</p>
            <p style="color: #FFF; line-height: 1.35; font-style: italic; border-left: 2px solid var(--gold); padding-left: 8px;">
                "Bonjour [Prénom], nous organisons prochainement un Afterwork privé dédié aux exploitants indépendants premium de la région. Face à la complexité des normes (Loi ALUR, DPE) et à l'inflation, nous offrons des solutions de cost-killing via Entegra. Afin de garantir des échanges Premium, nous souhaiterions échanger pour identifier les propriétaires locaux qui en bénéficieraient le plus. Seriez-vous disponible ce [Jour] ?"
            </p>
        </div>
    """
})
...
pages.append({
    ...
    "content": """
        <a id="annexe-9"></a>
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 9 : La Pression Commerciale Externe (1/2)</h1>
        
        <p style="font-size: 9.5pt; text-align: justify; margin-bottom: 10px; line-height: 1.45;">
            Cette annexe démontre l'étouffement numérique et la dépendance technologique subie par l'hébergeur Premium face aux OTAs.
        </p>

        <h2 style='font-size: 11pt; margin-top: 10px; color: var(--gold-light); margin-bottom: 5px;'>1. L'Hégémonie Absolue des OTAs (Marché Européen)</h2>
        <table class="table-compact">
            <tr style='background: rgba(221, 168, 62, 0.2);'><th style='width: 15%;'>Échéance</th><th style='width: 60%;'>Indicateur Sectoriel</th><th style='text-align: right;'>Valeur</th></tr>
            <tr><td style='padding: 4px 6px;'>2013</td><td style='padding: 4px 6px;'>Part de marché des OTAs</td><td style='padding: 4px 6px; text-align: right;'>19,7 %</td></tr>
            <tr><td style='padding: 4px 6px;'>2019</td><td style='padding: 4px 6px;'>Part de marché des OTAs</td><td style='padding: 4px 6px; text-align: right;'>29,2 %</td></tr>
            <tr style="background: rgba(255,255,255,0.05);"><td style='padding: 4px 6px; font-weight: bold;'>2023</td><td style='padding: 4px 6px; font-weight: bold;'>Part de marché des OTAs</td><td style='padding: 4px 6px; text-align: right; color: #E74C3C;'>29,6 %</td></tr>
            <tr><td style='padding: 4px 6px;'>2024</td><td style='padding: 4px 6px;'>Poids de Booking.com (du flux OTA)</td><td style='padding: 4px 6px; text-align: right; color: #E74C3C;'>69,3 %</td></tr>
            <tr style="border-top: 1px solid var(--border-glass);"><td style='padding: 4px 6px;'>2024</td><td style='padding: 4px 6px;'><strong>Marché Mondial (OTAs)</strong></td><td style='padding: 4px 6px; text-align: right; color: var(--gold); font-weight: bold;'>253,2 Mds $</td></tr>
        </table>
        
        <div class="expert-note" style="margin-top: 10px; padding: 10px 15px; font-size: 8.5pt;">
            <strong>Analyse : Le Piège de la Distribution</strong><br>
            Booking.com captant 70% des flux hôteliers digitaux en Europe, l'hébergeur indépendant a perdu le contrôle de ses marges (via la commission OTA). La promesse de Happy House (ré-internaliser la réservation directe, abaisser le mix OTA sous la barre vitale des 35%) répond à une urgence de survie économique.
        </div>
    """
})
...
pages.append({
    ...
    "content": """
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 9 : Pression Commerciale Externe (2/2)</h1>
        
        <h2 style='font-size: 11pt; margin-top: 10px; margin-bottom: 5px; color: var(--gold-light);'>2. L'Inflation des Certifications Écologiques</h2>
        <table class="table-compact">
            <tr style='background: rgba(221, 168, 62, 0.2);'><th>Année</th><th>Indicateur Sectoriel (France)</th><th style='text-align: right;'>Volume</th></tr>
            <tr><td style='padding: 4px 6px;'>2022</td><td style='padding: 4px 6px;'>Établissements labellisés "Clef Verte"</td><td style='padding: 4px 6px; text-align: right;'>855</td></tr>
            <tr><td style='padding: 4px 6px;'>2024</td><td style='padding: 4px 6px;'>Établissements labellisés "Clef Verte"</td><td style='padding: 4px 6px; text-align: right;'>1 564</td></tr>
            <tr style="background: rgba(255,255,255,0.05);"><td style='padding: 4px 6px; font-weight: bold;'>2025</td><td style='padding: 4px 6px; font-weight: bold;'>Projection "Clef Verte"</td><td style='padding: 4px 6px; text-align: right; color: var(--gold); font-weight: bold;'>2 428 (+184%)</td></tr>
            <tr><td style='padding: 4px 6px;'>2026</td><td style='padding: 4px 6px;'>Label historique "Qualité Tourisme"</td><td style='padding: 4px 6px; text-align: right; color: #E74C3C; font-weight: bold;'>Disparition</td></tr>
        </table>
        
        <div class="expert-note" style="margin-top: 10px; padding: 10px 15px; font-size: 8.5pt;">
            <strong>Analyse :</strong> La fatigue administrative (fin de Qualité Tourisme, pression Clef Verte) et l'hégémonie de Booking saturent l'hébergeur. Il cherche un partenaire de confiance (Afterworks) et non un énième logiciel.
        </div>

        <h2 style='font-size: 11pt; margin-top: 10px; margin-bottom: 5px; color: var(--gold-light);'>3. Synthèse de la Veille Technologique</h2>
        <table class="table-compact">
            <tr style='background: rgba(221, 168, 62, 0.2);'><th style='width: 25%;'>Outil Évalué</th><th style='width: 40%;'>Avantage</th><th style='width: 35%;'>Inconvénient</th></tr>
            <tr><td style='padding: 4px 6px;'>HubSpot</td><td style='padding: 4px 6px;'>Suite complète, adoption facile.</td><td style='padding: 4px 6px;'>Coût élevé (OPEX).</td></tr>
            <tr style="background: rgba(255,255,255,0.05); border-left: 3px solid #2ECC71;">
                <td style='padding: 4px 6px;'><strong>n8n + Gemini</strong> (Choix)</td>
                <td style='padding: 4px 6px; color: #2ECC71;'>Souveraineté data, IA native, coût quasi nul.</td>
                <td style='padding: 4px 6px;'>Courbe d'apprentissage.</td>
            </tr>
        </table>
    """
})
...
pages.append({
    ...
    "content": """
        <a id="annexe-11"></a>
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 11 : Extraits des Pièces Justificatives</h1>
        
        <p style="font-size: 9.5pt; text-align: center; margin-bottom: 10px; line-height: 1.45; color: var(--text-muted);">
        ...
        <div style="text-align: center; margin-bottom: 15px;">
            <a href="https://julienflorenceflorence-oss.github.io/rdm-prestige/" target="_blank" style="display: inline-block; background: var(--gold); color: #000; padding: 6px 15px; text-decoration: none; font-weight: bold; font-family: 'Arial', sans-serif; font-size: 8.5pt; letter-spacing: 1px; border-radius: 3px;">📥 ACCÉDER AU DOSSIER DRIVE SÉCURISÉ</a>
        </div>

        <div class="glass-card" style="padding: 12px 15px; margin-bottom: 15px; font-size: 9pt;">
            <div class="visual-title" style="color: var(--gold); font-size: 10pt; margin-bottom: 8px;">EXTRAIT 1 : LE PACK COMMUNICATION & CONTRAT (Conditions Générales)</div>
            <p style="color: #FFF; line-height: 1.4; margin: 0;">
                <strong>Livrable :</strong> Contrat d'adhésion liant le domaine "La Durentie" au réseau Happy House.<br>
                • <em>Art. 3 (Centrale d'Achats) :</em> Droits d'accès négociés Entegra (F&B, Blanchisserie, Énergies).<br>
                • <em>Art. 5 (Tarification) :</em> Formule "PRESTIGE" à 360 € HT annuel.<br>
                • <em>Art. 7 (Visibilité) :</em> Inclusion sur my-happyhouse.com et réseau Charme et Caractère sans commission.
            </p>
        </div>

        <div class="glass-card" style="padding: 12px 15px; border-color: #2ECC71; font-size: 9pt;">
            <div class="visual-title" style="color: #2ECC71; font-size: 10pt; margin-bottom: 8px;">EXTRAIT 2 : RELEVÉS DE PERFORMANCE (Tableau de Bord Durentie)</div>
            <p style="color: #FFF; line-height: 1.4; margin: 0;">
                <strong>Livrable :</strong> Extraction comptable prouvant le ROI de l'établissement au T4 2025.<br>
                • <em>Ligne 42 (Poste F&B) :</em> Commandes = 14 300 €. Économies Entegra (15%) = 2 145 €.<br>
                • <em>Ligne 58 (Blanchisserie) :</em> Renégociation kg linge = Gain net de 910 € en haute saison.<br>
                • <em>Conclusion :</em> Le gain couvre 11 fois le prix de la cotisation, validant la rétention 2026.
            </p>
        </div>
    """
})
...
pages.append({
    ...
    "content": """
        <a id="annexe-links"></a>
        <h1 style='color: var(--gold); text-align: center; border-bottom: 2px solid var(--gold); padding-bottom: 8px; margin-bottom: 10px;'>ANNEXE 12 : Social Selling (Réseau B2B)</h1>
        
        <p style="font-size: 9.5pt; text-align: center; margin-bottom: 15px; line-height: 1.45; color: var(--text-muted);">
            L'ancrage de la stratégie se matérialise par une forte présence LinkedIn attestant de la capacité à évangéliser le marché B2B.
        </p>

        <div style="display: flex; flex-direction: column; gap: 8px; align-items: center;">
            <h2 style='font-size: 11pt; color: var(--gold-light); margin-bottom: 5px; margin-top: 5px;'>PREUVES DE RAYONNEMENT B2B (LINKEDIN)</h2>
            
            <a href="https://www.linkedin.com/posts/julien-florence-2536a083_oenotourisme-artdevivre-vignobles-activity-7421884268253057024-Ofgh?utm_source=share&utm_medium=member_desktop&rcm=ACoAABG4o18BLawDZS3rFCCggwVoWwgws6scy_U" target="_blank" class="btn-nav" style="width: 85%; font-size: 9.5pt; text-align: left; padding-left: 20px; line-height: 1.3; padding-top: 6px; padding-bottom: 6px;">
                <span style="font-size: 11pt;">🍇</span> <strong>[Post Analytique]</strong> L'Œnotourisme & l'Art de Vivre
            </a>
            
            <a href="https://www.linkedin.com/posts/julien-florence-2536a083_serviceclient-excellence-sommelier-activity-7418976158194552832-DbgX?utm_source=share&utm_medium=member_desktop&rcm=ACoAABG4o18BLawDZS3rFCCggwVoWwgws6scy_U" target="_blank" class="btn-nav" style="width: 85%; font-size: 9.5pt; text-align: left; padding-left: 20px; line-height: 1.3; padding-top: 6px; padding-bottom: 6px;">
                <span style="font-size: 11pt;">🍷</span> <strong>[Réflexion]</strong> Excellence & Service Client (L'Héritage Sommelier)
            </a>
            
            <a href="https://www.linkedin.com/posts/julien-florence-2536a083_effetwaouh-hospitalitaez-happyhouse-activity-7417883359349022720-amMw?utm_source=share&utm_medium=member_desktop&rcm=ACoAABG4o18BLawDZS3rFCCggwVoWwgws6scy_U" target="_blank" class="btn-nav" style="width: 85%; font-size: 9.5pt; text-align: left; padding-left: 20px; line-height: 1.3; padding-top: 6px; padding-bottom: 6px;">
                <span style="font-size: 11pt;">✨</span> <strong>[Marque]</strong> L'Effet Waouh en Hospitalité (L'expérience Client)
            </a>
            
            <a href="https://www.linkedin.com/posts/julien-florence-2536a083_happyhouse-ecotourisme-toulouse-activity-7415346621812645890-4xin?utm_source=share&utm_medium=member_desktop&rcm=ACoAABG4o18BLawDZS3rFCCggwVoWwgws6scy_U" target="_blank" class="btn-nav" style="width: 85%; font-size: 9.5pt; text-align: left; padding-left: 20px; line-height: 1.3; padding-top: 6px; padding-bottom: 6px;">
                <span style="font-size: 11pt;">🌿</span> <strong>[Réseau]</strong> Écotourisme & Engagement Régional Happy House
            </a>
        </div>
        
        <div class="glass-card" style="margin-top: 20px; text-align: center; border: 1px solid #DDA83E; padding: 15px;">
            <p style="font-family: 'Cinzel', serif; font-size: 12pt; color: #DDA83E; margin: 0; font-weight: bold; letter-spacing: 2px;">
                FIN DU RAPPORT DE MISSION
            </p>
            <p style="font-size: 9pt; color: #DDA83E; margin-top: 3px; font-weight: bold;">ÉDITION V15 SOUTENANCE (ACADÉMIQUE)</p>
            <div style="width: 40px; height: 1px; background: #DDA83E; margin: 10px auto;"></div>
            <p style="font-size: 8.5pt; color: #888; margin-top: 8px; font-style: italic; margin-bottom: 0;">
...
# Resolution of Sommaire placeholders
page_map = {p["section"]: idx + 1 for idx, p in enumerate(pages)}
for section, page_num in page_map.items():
    final_html = final_html.replace("{{" + f"PAGE_{section}" + "}}", f"{page_num}")
    final_html = final_html.replace("{{" + f"PAGE_{section}_PAD" + "}}", f"{page_num:02d}")

base_path = os.path.dirname(os.path.abspath(__file__))
output_path = os.path.join(base_path, "..", "HTML", "RAPPORT_DE_MISSION_SOUTENANCE.html")

with open(output_path, "w", encoding="utf-8") as f:
    f.write(final_html)

print(f"[OK] HTML Rapport de Mission généré avec succès dans HTML/ ({page_number-1} pages).")
