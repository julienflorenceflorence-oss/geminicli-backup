...
def modify_original_pdf():
    ...
    # Solid background rect to completely cover old subtitle & old presentation text
    can.setFillColor(bg_main)
    can.setStrokeColor(bg_main)
    can.rect(195, 595, 395, 180, fill=1, stroke=0)
    ...
    print("✅ Correction totale du recouvrement du texte effectuée !")
